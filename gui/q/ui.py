...
class LoginPage(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        main_frame = tk.Frame(self, bg="#ffffff", height=1920, width=720)  # this is the background
        ...
        frame_login = tk.Frame(main_frame, bg="#ffffff", relief="groove", bd=0)  # this is the frame that holds all the login details and buttons
        frame_login.place(rely=0.04, relx=0.155, height=700, width=450)
        
        logo = PhotoImage(file="E:\gui\0422b061464097a7a0162f33e4c13a2e-65b9c08b245d704405a0b84497b4bf2684e16d5c/log.png") # Replace "logo.png" with your logo file
